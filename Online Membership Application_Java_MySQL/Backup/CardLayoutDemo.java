...
public class CardLayoutDemo extends JFrame implements ItemListener, ActionListener {
	...
	JTextField usernametext1, usernametext2; 
	JPasswordField passwordtext2, passwordtext1;
	...
	//		Iam.setFocusPainted( false );
        ...
        card2.add(new JButton("User Name"), c);
				...
				c.fill = GridBagConstraints.BOTH;
				//c.weighty = 0.2;
				 usernametext2 = new JTextField(20);
		card2.add(usernametext2, c);
				c.gridx = 0;
				c.gridy = 3;
				c.fill = GridBagConstraints.BOTH;
				//c.weighty = 0.2; 
	...
	public void actionPerformed(ActionEvent ae){
		...
		else if(source.equals("Sign_Up")){
			try{
				//System.out.println("In Member Sign Up");
			member_signUp();}
		...
		else if(source.equals("Admin Sign_Up")){
						admin_signUp();
		}
...
public void admin_signIn(){
	...
	myObject.setQuery("SELECT * FROM Admin where UserName ='"+username+"'");
