...
public class Admin_Modify_Member extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Admin_Modify_Member window = new Admin_Modify_Member();
	 ...
	 */
	public Admin_Modify_Member() throws Exception {
	...
	ObjectOutputStream myOutputStream = new ObjectOutputStream(socketToServer.getOutputStream());
		...
		else if(source.equals("Update Details")){
		//	dispose();
		try{
		//frame.dispose();
			//String username = textField_1.getText();
